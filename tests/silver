...
WHERE cust_az12_bdate < '1924-01-01' 
   OR cust_az12_bdate > GETDATE();
...
WHERE px_cat_g1v2_category != TRIM(px_cat_g1v2_category) 
   OR px_cat_g1v2_subcategory != TRIM(px_cat_g1v2_subcategory) 
   OR px_cat_g1v2_maintenance != TRIM(px_cat_g1v2_maintenance);
